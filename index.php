    ...
    <div class="container">
      <div class="d-flex flex-column flex-md-row align-items-center justify-content-center">
        ...
        <a href="http://www.indrasatya.com/" class="d-flex flex-column flex-md-row align-items-center justify-content-center me-md-auto py-2 py-md-0 text-decoration-none">
          ...
          <span class="text-white font-monospace fs-4">Mulyawan<span class="text-orange fs-5">.com</span></span>
        </a>
        <!-- button social media -->
        <div class="mb-2 mb-md-0">
          <a href="https://facebook.com/nizarmulyawan" target="_blank" class="btn btn-primary rounded-pill me-2">
            <i class="fab fa-facebook-f px-1 py-1"></i>
          </a>
          <a href="https://github.com/mulyawan02" target="_blank" class="btn btn-light rounded-pill me-2">
            <i class="fab fa-github py-1"></i>
          </a>
          <a href="https://www.youtube.com/" target="_blank" class="btn btn-danger rounded-pill">
    ...
    <div class="container">
      <div class="d-flex flex-column flex-md-row align-items-center align-items-md-left text-white">
        ...
        <div class="copyright text-center mb-2 mb-md-0">
          &copy; 2021 - <a href="http://www.mulyawan.com/" target="_blank">www.mulyawan.com</a>. All rights reserved.
        </div>
        <!-- link -->
        <div class="link ms-md-auto">
          <a href="http://www.mulyawan.com/" target="_blank" class="me-3">Syarat dan Ketentuan</a>
          <a href="http://www.mulyawan.com/" target="_blank">Lisensi</a>
        </div>
      </div>
    </div>
  </footer>
